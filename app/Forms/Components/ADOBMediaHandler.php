...
class ADOBMediaHandler extends FileUpload
{
    ...
    protected string $view = 'forms.components.a-d-o-b-media-handler';

    protected bool | Closure $allowPaste = false;

    protected function setUp(): void
    {
        parent::setUp();

        $this->loadStateFromRelationshipsUsing(static function (ADOBMediaHandler $component, HasMedia $record): void {
        ...
        $this->getUploadedFileUsing(static function (ADOBMediaHandler $component, string $file): ?array {
        ...
        $this->saveRelationshipsUsing(static function (ADOBMediaHandler $component) {
            $component->deleteAbandonedFiles();
            $component->saveUploadedFiles();
        });

        $this->saveUploadedFileUsing(static function (ADOBMediaHandler $component, TemporaryUploadedFile $file, ?Model $record): ?string {
        ...
        $this->reorderUploadedFilesUsing(static function (ADOBMediaHandler $component, array $state): array {
